			...
			<div class="panel panel-headline">
				<div class="panel-heading">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<form enctype="multipart/form-data" action="<?php echo base_url("ctr_admin\updatecategory"); ?>" method="post">
									<input type="text" hidden readonly="" name="category_id" value="<?= $result[0]['category_id']; ?>">
									<div class="form-group">
										<label for="nama_barang">Nama Kategori</label>
										<input type="text" id="category_name" name="category_name" class="form-control" value="<?=$result[0]['category_name']; ?>" required>
									</div>
									<div class="form-group">
									...
									<a href="<?php echo base_url("ctr_admin\category");?>" class="btn btn-warning">Cancel</a>
								</form>
							</div>
						</div>
					</div>
