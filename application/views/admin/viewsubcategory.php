			...
			<div class="panel panel-headline">
				<div class="panel-heading">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<form enctype="multipart/form-data" action="<?php echo base_url("ctr_admin\updatesubcategory"); ?>" method="post">
									<input type="text" hidden readonly="" name="material_sub_category_id" value="<?= $result[0]['material_sub_category_id']; ?>">
									<div class="form-group">
										<label for="nama_barang">Nama Sub Kategori</label>
										<input type="text" id="material_sub_category_name" name="material_sub_category_name" class="form-control" value="<?=$result[0]['material_sub_category_name']; ?>" required>
									</div>
									<div class="form-group">
