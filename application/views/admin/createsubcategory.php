			...
			<div class="panel panel-headline">
				<div class="panel-heading">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<form enctype="multipart/form-data" action="<?php echo base_url("ctr_admin\insertsubcategory"); ?>" method="post">
									...
									<div class="form-group">
										<label for="material_sub_category_photo">Foto Barang</label>
										<br>
